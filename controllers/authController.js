...
//    const message = `forgot your passoword? Submit a patch request with your new password 
...
//    res.status(200).json({status: 'success', message: 'Token sent to email'})}catch(err){
